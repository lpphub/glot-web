...
import { postMenu } from '@/service/api';
import {
  getLayoutAndPage,
...
type Button = Pick<Api.SystemManage.MenuButton, 'code' | 'desc'>;
...
async function handleSubmit() {
  ...
  const params = getSubmitParams() as Api.SystemManage.Menu;
  const { error } = await postMenu(params);
  if (!error) {
